...
export const REGISTERED_PROMPTS: ReadonlyArray<RegisteredPrompt> = Object.freeze([
  {
    id: "disclaimer-footer" as PromptId,
    version: "v1" as PromptVersion,
...
`,
    variables: Object.freeze(["data_as_of_timestamp"]),
    description: "|",
    created_at: "2026-05-11T17:30:00Z",
    deprecated_at: null,
  },
  {
    id: "eval-claim-extraction-v1" as PromptId,
    version: "v1" as PromptVersion,
    template: `You extract QUALITATIVE CLAIMS from one section of an equity research report.
...
`,
    variables: Object.freeze(["section", "ticker", "section_text"]),
  ...
  {
    id: "eval-judge-v1" as PromptId,
    version: "v1" as PromptVersion,
    template: `You are an expert financial-research-quality judge. You evaluate pairs of equity-research
...
`,
  ...
  {
    id: "gemini-citations-section" as PromptId,
    version: "v1" as PromptVersion,
    template: `=== CITATIONS ===
...
{{citations_json}}
`,
    variables: Object.freeze(["citation_count", "citations_json"]),
  ...
  {
    id: "gemini-cove-pass1-instruction" as PromptId,
    version: "v1" as PromptVersion,
    template: `
...
`,
  ...
  {
    id: "gemini-engine-context-block-active" as PromptId,
    version: "v1" as PromptVersion,
    template: `
...
`,
  ...
  {
    id: "gemini-engine-context-block-no-data" as PromptId,
    version: "v1" as PromptVersion,
    template: `
...
`,
    variables: Object.freeze(["cycle_count"]),
  ...
  {
    id: "gemini-per-doc-sentiment" as PromptId,
    version: "v1" as PromptVersion,
    template: `You are a senior equity research analyst classifying financial documents for sentiment and topical aspect.
...
{{docs_json}}
`,
    variables: Object.freeze(["docs_json"]),
  ...
  {
    id: "gemini-research-brief-system" as PromptId,
    version: "v1" as PromptVersion,
    template: `You are a senior equity research analyst at a bulge-bracket investment bank. Synthesize the provided market data, fundamentals, news, analyst sentiment, SEC filings, supplementary data, and community discussion into a Wall Street-grade structured research report. The goal is a report a serious investor can read and genuinely understand the company, its financial position, competitive dynamics, and investment merits — not a surface-level summary.
...
Return your analysis as a structured JSON object matching the provided schema.`,
  ...
  {
    id: "gemini-research-brief-user" as PromptId,
    version: "v1" as PromptVersion,
    template: `{{brief}}
...
{{news_section}}{{community_sentiment_section}}{{sentiment_intelligence_section}}{{community_intelligence_section}}Analyze the ticker based on all research data above. Return the structured analysis.`,
    variables: Object.freeze(["brief", "news_section", "community_sentiment_section", "sentiment_intelligence_section", "community_intelligence_section"]),
  ...
  {
    id: "gemini-smart-money-context-block" as PromptId,
    version: "v1" as PromptVersion,
    template: `
...
`,
  ...
  {
    id: "gemini-technical-context-block" as PromptId,
    version: "v1" as PromptVersion,
    template: `
...
`,
    variables: Object.freeze(["technical_sample_size", "technical_pattern", "cap_class", "technical_posterior_pct", "technical_ci", "technical_status", "horizon_rows", "combined_logistic_pct", "agreement"]),
  ...
  {
    id: "price-target-hedge" as PromptId,
    version: "v1" as PromptVersion,
    template: `Price target reflects analyst consensus or model-implied range as of {{data_as_of_timestamp}}; not a forecast or recommendation. {{ci_band_or_implied_range}}
`,
    variables: Object.freeze(["data_as_of_timestamp", "ci_band_or_implied_range"]),
    description: "|",
    created_at: "2026-05-11T17:30:00Z",
    deprecated_at: null,
  },
