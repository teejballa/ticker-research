...
// Phase 30.1-05 (D-25 / D-26): the COMMUNITY_SCAN_SOURCE flag has completed
// the off → shadow → on → flag-deleted lifecycle. The Xpoz Reddit + Twitter
// path is unconditionally active in production; the legacy alternative was
// removed in plan 30.1-05 Task 5.
