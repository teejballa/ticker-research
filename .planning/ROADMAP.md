...
- [ ] **Phase 21.1: Capacity to Detect Edge (INSERTED, absorbs Phase 23)**
  ...
  **Plans:** 7 plans across 7 waves (0..6)
  ...
  - [ ] 21.1-06-PLAN.md — Wave 6: HYPERPARAMETERS.md (D-07 Brier-lift + D-13 ridge + D-19 annealing) + scripts/check-feature-asof.ts CI gate + npm run phase-21.1-status composite gate + docs/paper/methodology.md citations + Phase 23 retirement annotation final-verify (CORE-ML-21 stub-completion, CORE-ML-25)
